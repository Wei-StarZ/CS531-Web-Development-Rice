...
export const STORE_TEMP_ARTICLES = "STORE_TEMP_ARTICLES"
...
export function storeTempArticles(allArticles) {
  return {type: STORE_TEMP_ARTICLES, allArticles}
}

export function changeComment(id) {
  return {type: CHANGE_COMMENT, id}
}
